...
function cards() {
    for (let i = 1; i <= 9; i++) {  // hacemos un for (que va del 1 al 9)
        ...
        `);  // realizamos el metodo .push para insertar dentro de este todo el contenido de las cards 
    }
}

// llamamos a la función para generar las cards
cards();

// seleccionamos el elemento con el id 'cards' y reemplazamos su contenido
document.querySelector("#cards").innerHTML = array.join().replaceAll(",", "");
